...
- In this project, we have setup our 3-Tier Application manually. This time we will create bash scripts to automate our VM creation/provisioning through Vagrantfile.
...
![VM running](https://i.imgur.com/6emvV33.png)
...
![](https://i.imgur.com/KE5v1rK.png)

- Backend services also up/running. 
![](https://i.imgur.com/BssKqvV.png)

- We can validate RabbitMq service.
![](https://i.imgur.com/uvDZcHr.png)

- Next we can check our DB/Memcache services.
![](https://i.imgur.com/QcOJfPN.png)
![](https://i.imgur.com/sTw40Fx.png)
